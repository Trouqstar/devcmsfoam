...
$allowed_categories = array(
    ...
    'memory-foam-sheets',
    'reconstituted-foam-sheets',
    'standard-foam-cushions',
    'ezi-dri-reticulated-foam-sheets',
    'gravidry',
    'closed-cell-foam',
    'foam-scrim'
);
    ...
    <div class="twc-inspired-sundries">
        <div class="twc-sidebar-wrapper">
            <div class="twc-sidebar">
                <h4 class="sidebar-title">Foam Products</h4>
                <ul class="category-list">
                    <li><a href="?">All Foam Products</a></li> <!-- Added "All" link -->
                    <li><a href="?category=polyurethane-foam-sheets">Polyurethane Foam Sheets</a></li>
                    <li><a href="?category=memory-foam-sheets">Memory Foam Sheets</a></li>
                    <li><a href="?category=reconstituted-foam-sheets">Reconstituted Foam Sheets</a></li>
                    <li><a href="?category=memory-foam-sheets">Memory Foam Sheets</a></li>
                    <li><a href="?category=standard-foam-cushions">Standard Foam Cushions</a></li>
                    <li><a href="?category=ezi-dri-reticulated-foam-sheets">Ezi Dri' Reticulated Foam Sheets</a></li>
                    <li><a href="?category=gravidry">Gravidry</a></li>
                    <li><a href="?category=closed-cell-foam">Closed Cell Foam</a></li>
                    <li><a href="?category=foam-scrim">Foam Scrim</a></li>

    ...
    <div class="twc-inspired-sundries">
        <div class="twc-sidebar-wrapper">
            <div class="twc-sidebar">
                <h4 class="sidebar-title">Vinyl & Linings</h4>
                <ul class="category-list">
                    <li><a href="?">All Vinyl & Linings</a></li> <!-- Added "All" link -->
                    <li><a href="?category=Vinyls">Vinyls</a></li>
                    <li><a href="?category=Linings">Linings</a></li>

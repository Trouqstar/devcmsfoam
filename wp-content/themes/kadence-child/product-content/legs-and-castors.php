    ...
    <div class="twc-inspired-sundries">
        <div class="twc-sidebar-wrapper">
            <div class="twc-sidebar">
                <h4 class="sidebar-title">Legs & Castors</h4>
                <ul class="category-list">
                    <li><a href="?">All Legs & Castors</a></li> <!-- Added "All" link -->
                    <li><a href="?category=wooden-feet-legs">Wooden Feet & Legs</a></li>
                    <li><a href="?category=Castors">Castors</a></li>
                    <li><a href="?category=Castors-Glides">Castors & Glides</a></li>

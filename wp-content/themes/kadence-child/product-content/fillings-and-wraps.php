    ...
    <div class="twc-inspired-sundries">
        <div class="twc-sidebar-wrapper">
            <div class="twc-sidebar">
                <h4 class="sidebar-title">Fillings & Wraps</h4>
                <ul class="category-list">
                    <li><a href="?">All Fillings & Wraps</a></li> <!-- Added "All" link -->
                    <li><a href="?category=Stockinette">Stockinette</a></li>
                    <li><a href="?category=Polyester-Fibre">Polyester Dacron</a></li>
                    <li><a href="?category=Scatter-Cushions">Scatter Cushions</a></li>
                    <li><a href="?category=fibres-fillings">Filling</a></li>

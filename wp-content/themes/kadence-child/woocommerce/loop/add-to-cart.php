...
<div class="action-button-wrap">
    <?php if ($product->is_type('variable')) : ?>
        ...
        <!-- Move the button outside the wrapper but keep it in the action-button-wrap -->
        <button
            type="button"
...
jQuery(document).ready(function($) {
    $('.custom-variation-wrapper').each(function() {
        ...
        // Find the button in the same action-button-wrap container
        const $button = $wrapper.closest('.action-button-wrap').find('.custom-add-to-cart-btn');

    ...
    <div class="twc-inspired-sundries">
        <div class="twc-sidebar-wrapper">
            <div class="twc-sidebar">
                <h4 class="sidebar-title">Threads & Trimmings</h4>
                <ul class="category-list">
                    <li><a href="?">All Threads & Trimmings</a></li> <!-- Added "All" link -->
                    <li><a href="?category=Twine">Twine</a></li>
                    <li><a href="?category=Piping-Cord">Piping Cord</a></li>
                    <li><a href="?category=Thread">Thread</a></li>
                    <li><a href="?category=Waxed Thread">Waxed Thread</a></li>
                    <li><a href="?category=Decorative-Nailstrip">Decorative Nailstrip</a></li>
                    <li><a href="?category=Decorative-Nails">Loose Decorative Nails</a></li>
                    <li><a href="?category=Gimp-Trimmings">Trimmings</a></li>
